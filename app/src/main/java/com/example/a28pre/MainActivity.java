...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Получим ссылку на кота
        ImageView catImageView = findViewById(R.id.cat);
        // Анимация для прыжка кота
        Animation catJumpAnimation = AnimationUtils.loadAnimation(this, R.anim.cat_jump);
        // Подключаем анимацию к коту
        catImageView.startAnimation(catJumpAnimation);
    }
}